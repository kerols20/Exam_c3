...
import '../api/auth/data_source_impl/VerifyResetCodeDataSourceImpl.dart'
    as _i974;
import '../api/home/Data_Source_Imp/Get_Exams_by_Id_subject_Data_source_imp.dart'
    as _i42;
import '../api/home/Data_Source_Imp/Get_qustion_by_Exams_Data_source_imp.dart'
    as _i1070;
...
import '../Data/home/repositries_Imp/Get_Exams_by_Id_subject_Rpo_imp.dart'
    as _i737;
import '../Data/home/repositries_Imp/Get_qustion_by_Exams_Id_Rpo_imp.dart'
    as _i394;
...
import '../domin/home/repositries/Get_Exams_by_Id_subject_Rpo.dart' as _i354;
import '../domin/home/repositries/Get_qustion_by_Exams_Id_Rpo.dart' as _i974;
import '../domin/home/repositries/Get_subjects_Rpositeries.dart' as _i238;
import '../domin/home/UsaCase/Get_Exams_by_Id_subject_UseCse.dart' as _i173;
import '../domin/home/UsaCase/Get_Exams_by_Id_Usecase.dart' as _i188;
import '../domin/home/UsaCase/Get_subjects_Use_Case.dart' as _i958;
import '../viweModel/Home_viwe_model/Home_viwe_model.dart' as _i614;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i199.Get_qustion_by_Exams_Data_source>(
      () => _i1070.Get_qustion_by_Exams_Data_source_imp(gh<_i875.ApiClient>()),
    );
    gh.factory<_i146.Get_Exams_by_Id_subject_Data_source>(
      () => _i42.Get_Exams_by_Id_subject_model_Data_Source_Imp(
        gh<_i875.ApiClient>(),
      ),
    );
    ...
    gh.factory<_i354.Get_Exams_by_Id_subject_Rpo>(
      () => _i737.Get_Exams_by_Id_subject_Rpo_Imp(
        gh<_i146.Get_Exams_by_Id_subject_Data_source>(),
      ),
    );
    ...
    gh.factory<_i974.Get_qustion_by_Exams_Id_Rpo>(
      () => _i394.Get_qustion_by_Exams_Id_Rpo_imp(
        gh<_i199.Get_qustion_by_Exams_Data_source>(),
      ),
    );
    gh.factory<_i173.Get_Exams_by_Id_subject_UseCse>(
      () => _i173.Get_Exams_by_Id_subject_UseCse(
        gh<_i354.Get_Exams_by_Id_subject_Rpo>(),
      ),
    );
    ...
    gh.factory<_i188.Get_Exams_by_Id_Usecase>(
      () => _i188.Get_Exams_by_Id_Usecase(
        gh<_i974.Get_qustion_by_Exams_Id_Rpo>(),
      ),
    );
    ...
    gh.factory<_i614.Home_viwe_model>(
      () => _i614.Home_viwe_model(
        gh<_i958.Get_subject_Use_Case>(),
        gh<_i173.Get_Exams_by_Id_subject_UseCse>(),
        gh<_i188.Get_Exams_by_Id_Usecase>(),
      ),
    );
    return this;
  }
