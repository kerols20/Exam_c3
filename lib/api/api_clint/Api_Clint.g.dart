...
class _ApiClient implements ApiClient {
  ...
  Future<Sign_in_response> signIn(SignInRequest request) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<Sign_in_response>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'v1/auth/signIn',
    ...
    late Sign_in_response _value;
    try {
      _value = Sign_in_response.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<Get_subjects_Rsonse> Get_subjects(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Get_subjects_Rsonse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Get_subjects_Rsonse _value;
    try {
      _value = Get_subjects_Rsonse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<Get_Exams_by_Id_subject> Get_Exams(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Get_Exams_by_Id_subject>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'v1/exams',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Get_Exams_by_Id_subject _value;
    try {
      _value = Get_Exams_by_Id_subject.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<Get_qustion_by_Exam_id> Get_qustion_by_Exam(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Get_qustion_by_Exam_id>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'v1/questions',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Get_qustion_by_Exam_id _value;
    try {
      _value = Get_qustion_by_Exam_id.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<UserInfoResponse> getProfileData(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<ChangeProfilePasswordResponse> changePassword(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<ChangeProfilePasswordResponse>(
